defmodule EatbeepWeb.Menu.Dynamic do
  ...
  def render(assigns) do
    ...
    <div class="group focus-within:border-blue-500 border-transparent hover:border-blue-500 border-2 relative">
      ...
      <div class="hidden items-center w-full group-hover:flex space-x-2 bottom-0 -mb-4 absolute ">
        <div class="mx-auto p-2 shadow bg-white rounded">
          ...
          <button type="button" :on-click="add_block" phx-value-type="product" phx-value-after={{ @block.bid }} class="btn btn-sm btn-light">Product</button>
        </div>
      </div>
